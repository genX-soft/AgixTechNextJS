    ...
    const result = await submitLead(
      {
        ...
        challenges: [formData.useCase],
      },
      {
        formType: "vision-readiness",
        source: "/services/computer-vision",
        ctaId: "computer-vision-form-submit",
        ctaText: "Request Vision AI Consultation",
        ctaLocation: "/services/computer-vision",
      }
    );
