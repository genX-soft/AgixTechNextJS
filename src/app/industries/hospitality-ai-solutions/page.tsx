    ...
    const result = await submitLead(
      {
        ...
        companySize: formData.dailyGuests,
        challenges: [formData.challenge],
      },
      {
        formType: "hospitality-roadmap",
        source: "/industries/hospitality",
        ctaId: "hospitality-form-submit",
        ctaText: "Get My Experience Roadmap",
        ctaLocation: "/industries/hospitality",
        additionalMetadata: {
...
export default function HospitalityIndustryPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-24 lg:pt-28 pb-16 bg-gradient-to-br from-background via-pink-500/5 to-primary/10">
      ...
      <IndustryCaseStudies caseStudies={caseStudies} industryName="Hospitality" />

      {/* Industry Services Section */}
      <IndustryServices services={industryServices} industryName="Hospitality" />
