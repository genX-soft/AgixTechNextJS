...
const faqs = [
  ...
  { question: "What level of technical expertise does our team need?", answer: "No coding or technical expertise required for day-to-day operations. We provide intuitive dashboards and interfaces. Your team will receive training on system oversight, while AGIX Technologies handles all technical maintenance and updates." },
