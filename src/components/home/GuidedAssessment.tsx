...
interface ResultLevel {
  ...
  description: string;
  whatAiCanDo: string[];
  recommendedPath: { title: string; link: string };
  journey: { now: string; next: string; later: string };
    ...
    resultLevels: [
      {
        ...
        recommendedPath: { title: "Start with Operational Intelligence", link: "/intelligence/operational-ai/" },
        journey: { now: "Simple AI-powered automation", next: "Conversational AI (chat/voice)", later: "Decision & analytics systems" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Conversational Intelligence", link: "/intelligence/conversational-ai/" },
        journey: { now: "Chatbots and workflow automation", next: "Predictive analytics", later: "Advanced decision systems" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Decision Intelligence", link: "/intelligence/decision-ai/" },
        journey: { now: "Decision support and analytics", next: "Autonomous AI agents", later: "Enterprise-wide AI transformation" },
        nextActions: [
    ...
    resultLevels: [
      {
        ...
        recommendedPath: { title: "AI Automation + Lightweight Conversational AI", link: "/services/conversational-ai-chatbots/" },
        journey: { now: "Automation + AI copilots", next: "Custom AI features", later: "Agentic workflows" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Custom AI Product Development", link: "/services/custom-ai-product-development/" },
        journey: { now: "Custom AI features", next: "Advanced automation", later: "AI-first product strategy" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Agentic AI Systems", link: "/services/agentic-ai-systems/" },
        journey: { now: "Agentic workflows", next: "AI platform capabilities", later: "AI-native architecture" },
        nextActions: [
    ...
    resultLevels: [
      {
        ...
        recommendedPath: { title: "Operational Intelligence", link: "/intelligence/operational-ai/" },
        journey: { now: "Targeted workflow automation", next: "Process optimization", later: "Predictive operations" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Operational + Decision Intelligence", link: "/intelligence/decision-ai/" },
        journey: { now: "Workflow automation", next: "Predictive insights", later: "Agent-assisted operations" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Enterprise-Grade AI Transformation", link: "/intelligence/enterprise-knowledge-ai/" },
        journey: { now: "Immediate automation wins", next: "Decision intelligence systems", later: "Autonomous operations" },
        nextActions: [
    ...
    resultLevels: [
      {
        ...
        recommendedPath: { title: "Enterprise AI Readiness Framework", link: "/intelligence/enterprise-knowledge-ai/" },
        journey: { now: "Readiness & risk assessment", next: "Controlled AI deployment", later: "Agentic & decision systems" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Enterprise Knowledge Intelligence", link: "/intelligence/enterprise-knowledge-ai/" },
        journey: { now: "Governance & orchestration", next: "Scaled deployment", later: "Autonomous enterprise AI" },
        nextActions: [
      ...
      },
      {
        ...
        recommendedPath: { title: "Agentic AI Systems", link: "/intelligence/autonomous-agentic-ai/" },
        journey: { now: "Scaled AI deployment", next: "Autonomous systems", later: "AI-native enterprise" },
        nextActions: [
...
function InlineAssessment({
  ...
  const resultLevel =
    config.resultLevels.find((l) => totalScore >= l.minScore && totalScore <= l.maxScore) ||
    ...
    >
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <Button variant="ghost" size="sm" onClick={onClose} data-testid="button-close-assessment">
            ...
            >
              <Card className="border-border/50 overflow-hidden">
                <CardContent className="p-8 md:p-12 text-center space-y-6">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold">{config.title}</h3>
                  <p className="text-muted-foreground max-w-xl mx-auto">{config.subtitle}</p>
                  ...
                  <Button size="lg" onClick={() => setStep("questions")} data-testid="button-start-inline-assessment">
                    Start Assessment
              ...
              <Card className="border-border/50 overflow-hidden">
                <div className="p-4 border-b border-border/50">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Button variant="ghost" size="sm" onClick={goBack} disabled={currentQuestion === 0}>
              ...
              <Card className="border-border/50 overflow-hidden">
                <CardContent className="p-8 md:p-12 space-y-8">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-muted-foreground max-w-lg mx-auto">{resultLevel.description}</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid sm:grid-cols-3 gap-4">
                      {(["now", "next", "later"] as const).map((phase) => (
                        <div key={phase} className="p-4 rounded-lg bg-muted/20 border border-border/50">
                          <Badge variant="secondary" className="mb-2 capitalize">{phase}</Badge>
                          <p className="text-sm text-muted-foreground">{resultLevel.journey[phase]}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4">
                    {resultLevel.nextActions.map((action, i) => (
                      <Button key={i} variant={i === 0 ? "default" : "outline"} asChild className="flex-1">
...
export default function GuidedAssessmentSection() {
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {assessmentTools.map((tool, index) => (
                  ...
                  >
                    ...
                    >
                      <Card
                        className="h-full min-h-[280px] hover-elevate border-border/50 group"
                        data-testid={`card-tool-${tool.forLabel.toLowerCase().replace(/\s+/g, "-")}`}
                      >
                        <CardContent
                          className={`p-6 h-full bg-gradient-to-br ${tool.color} rounded-lg flex flex-col`}
                        >
