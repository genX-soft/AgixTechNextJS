            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="text-left">
                        ...
                        <FormControl>
                          <Input placeholder="John Smith" className="h-10" {...field} data-testid="input-cta-name" autoComplete="name" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="text-left">
                        ...
                        <FormControl>
                          <Input placeholder="john@company.com" type="email" className="h-10" {...field} data-testid="input-cta-email" autoComplete="email" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="text-left">
                        ...
                        <FormControl>
                          <Input placeholder="Acme Inc." className="h-10" {...field} data-testid="input-cta-company" autoComplete="organization" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="text-left">
                        ...
                        <FormControl>
                          <Input placeholder="VP of Engineering" className="h-10" {...field} data-testid="input-cta-role" autoComplete="organization-title" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={() => (
                    <FormItem className="text-left">
                      <p className="text-sm font-medium leading-none mb-2">What challenges are you facing? (Select all that apply)</p>
