...
const linkClassName = "text-sm text-slate-300 hover:text-white transition-colors";
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-6">
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <div className="space-y-4">
              <a href="tel:+18574141353" className="flex items-center gap-2 text-sm text-slate-300 hover:text-white transition-colors">
                <Phone className="h-4 w-4 text-primary" aria-hidden="true" />
                +1 857 4141 353
              </a>
              <a href="mailto:santosh@agixtech.com" className="flex items-center gap-2 text-sm text-slate-300 hover:text-white transition-colors">
