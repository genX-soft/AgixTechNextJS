  ...
  async headers() {
    const securityHeaders = [
      ...
      { key: 'Cross-Origin-Opener-Policy', value: 'same-origin-allow-popups' },
      {
        ...
        value: [
          "default-src 'self'",
          // 'unsafe-eval' is required in dev for Next.js HMR; excluded in production
          `script-src 'self' 'unsafe-inline'${isDev ? " 'unsafe-eval'" : ''} https://www.googletagmanager.com https://www.google-analytics.com https://www.clarity.ms https://scripts.clarity.ms`,
          "script-src-attr 'none'",
          "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
          "font-src 'self' data: https://fonts.gstatic.com",
          "img-src 'self' data: blob: https:",
          "media-src 'self' https:",
          "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://www.googletagmanager.com https://region1.google-analytics.com https://cms.agixtech.com https://b.clarity.ms https://e.clarity.ms",
