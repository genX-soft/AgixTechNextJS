  ...
  const leadMutation = useMutation({
    mutationFn: async (data: typeof formData) => {
      return apiRequest("POST", "/api/leads", {
        ...data,
        source: "custom-ai-product-development",
    ...
    <Card className="bg-background/90 backdrop-blur-md border-primary/30 shadow-xl shadow-primary/5">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-cyan-600 hover:bg-cyan-700 text-white border-cyan-600" size="lg" disabled={leadMutation.isPending} data-testid="button-submit-lead">
