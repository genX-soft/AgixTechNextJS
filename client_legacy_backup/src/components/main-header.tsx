...
const corporateItems = [
  ...
  { title: "Career", href: "/corporate/careers", icon: Briefcase, description: "Join our team and grow with us" },
  { title: "News & Media", href: "/corporate/news", icon: Newspaper, description: "Latest news and media coverage" },
    ...
    return (
      <div role="group">
        <button
          ...
          className="flex items-center justify-between w-full px-4 py-3 text-sm font-medium text-foreground hover-elevate rounded-md"
              ...
              <div className="pl-4 pb-2 space-y-1">
                {items.map((item) => (
                  <Link
                    ...
                    href={item.href}
                    onClick={onItemClick}
                    className="block px-4 py-2 text-sm text-muted-foreground hover-elevate rounded-md"
        ...
        <div className="flex items-center justify-between h-16 gap-4">
                  ...
                  <DropdownMenuContent align="end" className="w-[320px] p-2">
                    {corporateItems.map((item) => (
                      <DropdownMenuItem key={item.href} asChild className="p-0">
                        <a
                          href={item.href}
                          className="flex items-center gap-3 p-3 rounded-md hover-elevate w-full"
          ...
          <div className="flex items-center gap-4">
            ...
            <Button asChild className="hidden md:inline-flex">
              <a href="/schedule-consultation" data-testid="button-schedule-consultation">
          ...
          >
            <nav className="max-w-7xl mx-auto px-4 py-4 space-y-1">
              ...
              <MobileMenuItem
                ...
                onItemClick={closeMobileMenu}
              />
              <MobileMenuItem title="Insights" href="/insights" onItemClick={closeMobileMenu} />
              ...
              <div className="pt-4 border-t border-border mt-4 space-y-3">
                ...
                <div className="px-4">
                  <Button asChild className="w-full">
                    <a href="/schedule-consultation" data-testid="button-mobile-schedule-consultation">
                      Schedule Free Consultation
                    </a>
                  </Button>
                </div>
